...
class ArbitrageService {
	...
	async startArbitrageTransferFromEthToBsc(amount, amountUsd, arbitrageBlxmBalance, balanceUsdc) {
	...
	async startArbitrageTransferFromBscToEth(amount, amountUsd, arbitrageBlxmBalance, balanceUsdc) {
		// is liqudity avaible ? 
		if (!arbitrageBlxmBalance.isZero()) {
	...
	async _bridgeAndSwapToBsc(amount, abitrageBalance) {
		...
		logger.info("Swapping : [" + ethers.utils.formatEther(swapAmount) + "] BLXM to USDC in BSC.");
