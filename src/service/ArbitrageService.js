...
class ArbitrageService {
	...
	minimumSwapAmount(poolPriceBsc, poolPriceEth){
        ...
        let transactions = (countTransactionsPerCycle(poolPriceBsc, poolPriceEth))
        ...
        if(poolPriceBsc > poolPriceEth){
            var priceExpensiveBLXM = poolPriceBsc;
            var priceCheapBLXM = poolPriceEth;
        } else {
            var priceExpensiveBLXM = poolPriceEth;
            var priceCheapBLXM = poolPriceBsc;
        };
        
        let standardDeviation = getStandardDeviation();
