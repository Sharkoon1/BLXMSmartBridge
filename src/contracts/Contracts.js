...
class Contracts  {
	constructor(network, signer) {
		...
		if(this._network === "BSC") {
			...
			this.arbitrageContract = new ArbitrageContract(constants.ARBITRAGE_CONTRACT_ADDRESS_BSC, signer);
		}
			...
			this.arbitrageContract = new ArbitrageContract(constants.ARBITRAGE_CONTRACT_ADDRESS_ETH, signer);
		}
	}
}
